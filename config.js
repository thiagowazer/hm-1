...
const apikeyimgbb = '6d62958a0739104984a8ba885bd44273'
...
const banmsgporn = '𝙐𝙈 𝙋𝙐𝙉𝙃𝙀𝙏𝙀𝙄𝙍𝙊 𝙁𝙊𝙄 𝘿𝙀𝙏𝙀𝘾𝙏𝘼𝘿𝙊'
// mensagem de ban no antiporn

const adminmsgporn = '*Tu é adm ent n vou te banir por mandar porno*'
// mensagem de quando adm manda porn com antiporn ativado

const banmsglink = 'Link detectado, você sera expulso imediatamente!!'
// mensagem de ban no antilink

const adminmsglink = 'Isso é um link amigo... ah é tu é adm ent pode 🤙'
